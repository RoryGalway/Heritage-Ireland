...
public class DromoreWood extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.dromorewood);
	...
	private OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v){		
			switch(v.getId()){
			case R.id.share:
				Adare.Share(DromoreWood.this, "Dromore Wood","Nature reserve");	
                break;
			case R.id.directions:
				WebView web;
            	web = new WebViewHelper().webview(DromoreWood.this);
                // specify the URL we want to load
            	 web.loadUrl("http://maps.google.com/maps?saddr=Current%20Location&daddr=52.7164544, -8.8615971");
                setContentView(web);
	               break;
			case R.id.add:
				String Altmont = "DromoreWood";
            	// Below is the adding to the db code
            	databaseHelper = new DatabaseHelper(DromoreWood.this, null,null, 1);
            	Products product = new Products(Altmont.toString());
            	databaseHelper.addProduct(product);
            	Adare.saved(DromoreWood.this);
	            break;
